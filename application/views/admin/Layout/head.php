...
<head>
    ...
    <title>Welcome To | OffersBull-Admin</title>
    <!-- Favicon-->
    ...
    <!-- Bootstrap Core Css -->
    <link href="<?php echo base_url();?>assets_admin/plugins/bootstrap/css/bootstrap.css" rel="stylesheet">

    <!-- Waves Effect Css -->
    <link href="<?php echo base_url();?>assets_admin/plugins/node-waves/waves.css" rel="stylesheet" />
