...
<?php 
	...
	$realestate_data = $this->db->order_by('date','desc')->get_where('automobile')->result_array();
?>                                
                                     <?php foreach ($realestate_data as $row){?>
								      <tr>
                                        ...
                                        <td><a href="<?php echo base_url();?>index.php/Admin/automobile_edit/<?php echo $row['autoid'];?>"><button class="btn btn-success">Edit</button></a></td>
								        <td><a href="<?php echo base_url();?>index.php/Admin/automobile/delete/<?php echo $row['autoid'];?>/<?php echo $row['userid'];?>"><button class="btn btn-danger">Delete</button></a></td>
                                       </tr> 
                                       <?php }?> 
                                </tbody>
                            </table>
