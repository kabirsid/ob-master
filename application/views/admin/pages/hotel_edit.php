<?php 
	...
	$query = "SELECT * from hotel WHERE hotelid='$realid'";
...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>HOTEL / EDIT / ID : <?php echo $realid;?></h2>
            </div>
            <!-- CONTAINER ADD -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <?php foreach ($realedit->result_array() as $row){?>	
                        	<form action="<?php echo base_url();?>index.php/Admin/hotel/update/<?php echo $row['hotelid'];?>" id="frmFileUpload" method="post" enctype="multipart/form-data">
								<div class="row clearfix">
	                                <div class="col-md-4">
	                                    ...
	                                    <label for="type">Type </label><span style="color: red;"> * </span><span style="color: red;" class="error" id="type_error"></span>
										  <div class="form-line">	
										  	<select required="required" name="type">
	                                            	...
	                                            	<option <?php if($row['type']=="Hotel"){ echo 'selected';}?> value="Hotel">Hotel</option>
	                                            	<option <?php if($row['type']=="Restaurants"){ echo 'selected';}?> value="Restaurants">Restaurants</option>
	                                        </select>
										  </div>	
	                                </div>
	                                 <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Edit / Delete images</h2>
                        	 ...
                        	 <?php 
			                    $query = "SELECT hotel.hotelid, hotel.`name`, hotel.title, hotel.type, hotel.address, hotel.price, hotel.description, hotel.mobile, hotel.email, hotel.amenities, hotel.city, hotel.area, hotel.date, hotel.offerend, hotel.category, hotel.userid, hotel_img.hotelid, hotel_img.path, hotel_img.id FROM hotel INNER JOIN hotel_img ON hotel.hotelid = hotel_img.hotelid WHERE hotel.hotelid = $realid";
			                    ...
			                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
					                ...
					                <form action="<?php echo base_url();?>index.php/Admin/UpdateImage/hotel" method="post" enctype="multipart/form-data">
					                	<input type="hidden" name="imgid" value="<?php echo $row_img["id"];?>">
					                	<input type="hidden" name="postid" value="<?php echo $row_img["hotelid"];?>">
					                	<input type="file" name="image" required="required">
					                	<input type="submit" class="btn btn-success" value="Change Image">
					                </form>
					                <br>
					                <a href="<?php echo base_url();?>index.php/Admin/DeleteImage/hotel/<?php echo $row_img["id"];?>/<?php echo $row_img["hotelid"];?>"><input type="submit" class="btn btn-danger" value="Delete Image  &nbsp;"></a>
					                <hr>
				                </div>
				                <?php }?>
                	</div> 
