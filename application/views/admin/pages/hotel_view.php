<section class="content">
        ...
        <div class="block-header">
                <h2>HOTEL and RESTURENTS / View</h2>
            </div>
            <!-- Exportable Table -->
...
<?php 
	...
	$realestate_data = $this->db->order_by('date','desc')->get_where('hotel')->result_array();
?>                                
                                     <?php foreach ($realestate_data as $row){?>
								      <tr>
								       <?php if ($row['userid']==0){?>
                                        ...
                                        <td><a href="<?php echo base_url();?>index.php/Admin/hotel_edit/<?php echo $row['hotelid'];?>"><button class="btn btn-success">Edit</button></a></td>
								        <td><a href="<?php echo base_url();?>index.php/Admin/hotel/delete/<?php echo $row['hotelid'];?>/<?php echo $row['userid'];?>"><button class="btn btn-danger">Delete</button></a></td>
                                       </tr> 
                                       <?php }?> 
                                </tbody>
                            </table>
