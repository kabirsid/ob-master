...
<?php 
	...
	$realestate_data = $this->db->order_by('date','desc')->get_where('realestate')->result_array();
?>                                
                                     <?php foreach ($realestate_data as $row){?>
								      <tr>
								       <?php if ($row['userid']==0){?>
                                        ...
                                        <td><a href="<?php echo base_url();?>index.php/Admin/realestate_edit/<?php echo $row['realid'];?>"><button class="btn btn-success">Edit</button></a></td>
								        <td><a href="<?php echo base_url();?>index.php/Admin/realestate/delete/<?php echo $row['realid'];?>/<?php echo $row['userid'];?>"><button class="btn btn-danger">Delete</button></a></td>
                                       </tr> 
                                       <?php }?> 
                                </tbody>
                            </table>
