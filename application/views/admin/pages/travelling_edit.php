<?php 
	...
	$query = "SELECT * from travelling WHERE travelid='$realid'";
...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>TRAVELLING / EDIT / ID : <?php echo $realid;?></h2>
            </div>
            <!-- CONTAINER ADD -->
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>Edit Travelling</h2>
                        </div>
                        <div class="body">
                        <?php foreach ($realedit->result_array() as $row){?>	
                        	<form action="<?php echo base_url();?>index.php/Admin/travelling/update/<?php echo $row['travelid'];?>" id="frmFileUpload" method="post" enctype="multipart/form-data">
								<div class="row clearfix">
	                                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Edit / Delete images</h2>
                        	 ...
                        	 <?php 
			                    $query = "SELECT travelling.travelid, travelling.`name`, travelling.title, travelling.address, travelling.price, travelling.description, travelling.mobile, travelling.email, travelling.city, travelling.area, travelling.date, travelling.offerend, travelling.category, travelling.userid, travelling_img.travelid, travelling_img.path, travelling_img.id FROM travelling INNER JOIN travelling_img ON travelling.travelid = travelling_img.travelid WHERE travelling.travelid = $realid";
			                    ...
			                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
					                ...
					                <form action="<?php echo base_url();?>index.php/Admin/UpdateImage/travelling" method="post" enctype="multipart/form-data">
					                	<input type="hidden" name="imgid" value="<?php echo $row_img["id"];?>">
					                	<input type="hidden" name="postid" value="<?php echo $row_img["travelid"];?>">
					                	<input type="file" name="image" required="required">
					                	<input type="submit" class="btn btn-success" value="Change Image">
					                </form>
					                <br>
					                <a href="<?php echo base_url();?>index.php/Admin/DeleteImage/travelling/<?php echo $row_img["id"];?>/<?php echo $row_img["travelid"];?>"><input type="submit" class="btn btn-danger" value="Delete Image  &nbsp;"></a>
					                <hr>
				                </div>
				                <?php }?>
                	</div> 
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                     ...
                     <div class="body">
                            <form action="<?php echo base_url();?>index.php/Admin/AddMoreImages" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="category" value="travelling">
                                <div class="dropzone"> 
