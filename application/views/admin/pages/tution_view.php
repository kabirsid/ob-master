...
<?php 
	...
	$realestate_data = $this->db->order_by('date','desc')->get_where('tution')->result_array();
?>                                
                                     <?php foreach ($realestate_data as $row){?>
								      <tr>
								       <?php if ($row['userid']==0){?>
								        ...
								        <td><a href="<?php echo base_url();?>index.php/Admin/tution/delete/<?php echo $row['tutid'];?>/<?php echo $row['userid'];?>"><button class="btn btn-danger">Delete</button></a></td>
                                       </tr> 
                                       <?php }?> 
                                </tbody>
                            </table>
