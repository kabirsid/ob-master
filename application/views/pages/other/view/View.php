            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeIn">
                        <h1>Other / <span class="post_title"><?php echo $title;?></span></h1>
                    </div>
                </div>
            </div>
        </div>
	            ...
	            <div class="row">
	            	<div class="col-sm-12 portfolio-masonry">
		                ...
		                foreach ($SimilarResults as $SimilarRow) {
					 		$SimilarRealid = $SimilarRow['otherid'];
					 	...
					 	?>	
		                <div class="portfolio-box web-design">
		                	<a href="<?php echo base_url()."index.php/Other/view/"."$SimilarRealid"; ?>">
		                	<div class="portfolio-box-container">
