...
<div class="col-md-12">
 ...
 <table class="table table-hover">
    ...
    <tbody>
      <?php foreach ($automobile_data as $row){?>
      <tr>
        ...
        <td><a href="<?php echo base_url();?>index.php/Basic_Controller/user_automobile_edit/<?php echo $row['autoid'];?>"><button class="btn btn-success">Edit</button></a></td>
        <td><a href="<?php echo base_url();?>index.php/Basic_Controller/user_automobile/delete/<?php echo $row['autoid'];?>"><button class="btn btn-danger">Delete</button></a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
