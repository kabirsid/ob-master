...
<?php 
	...
	$query = "SELECT * from other WHERE otherid='$otherid' and userid='$userid'";
...
?>
<form id=other_form method="post" action="<?php echo base_url();?>index.php/Basic_Controller/user_other/update/<?php echo $row['otherid'];?>" enctype="multipart/form-data">
	<div class="col-md-6">
	<input type="hidden" name="realid" value="<?php echo $row['otherid'];?>">
