...
<!--<div class="col-md-6">
  ...
  <!--   
	...
	<div class="form-group">
	  ...
	  <div class="col-md-6">
		<div class="form-group">
	  		...
	  		<input type="text" class="form-control" id="offersmenu" name="offersmenu" placeholder="menu">
		</div>
	  </div>
	<!--  <div class="col-md-6">
	  	 <div class="form-group">
	  <label for="Image">Description of menu:</label>
	<textarea class="form-control"  name="offersdescription" id="offersdescription"></textarea>
	  </div>
	  </div>-->
	  <div class="col-md-6">
	  <div class="form-group">
	  <label for="Image">Offer in percentage:</label>
	  <input type="text" class="form-control" name="offersdiscount" id="offersdiscount" placeholder="offer in percentage">
	  </div>
	  </div>
	...
	<div class="col-md-9">
	<button type="submit" class="btn btn-success">Post</button></div>
	<?php }?>
</form>
</div>
<div class="col-md-3">
